...
export class UpdateTableQuestionV31685503890237 implements MigrationInterface {
  name = 'UpdateTableQuestionV31685503890237';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`question\` CHANGE \`text111\` \`text\` varchar(255) NULL`,
    );
    await queryRunner.query(`ALTER TABLE \`question\` DROP COLUMN \`text\``);
    await queryRunner.query(
      `ALTER TABLE \`question\` ADD \`text\` varchar(255) NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`question\` CHANGE \`text\` \`text111\` varchar(255) NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX \`IDX_f34f55e28e318adcf7f8dc582c\` ON \`variation_category\` (\`category_id\`)`,
    );
